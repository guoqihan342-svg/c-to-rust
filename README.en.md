...
| Latest development stage | P0-A18b2a: readonly byte-slice and CRC32 paths now use ReplayCallPlan with inline fixtures and JSON byte arrays |
| Active translator task | P0-A18b2b: add plan-v2 bindings/borrows/observations for record state, then scripted external/call-continue paths |
