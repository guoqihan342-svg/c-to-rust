...
| Latest development stage | P0-A18b2b2b: all four scripted external/call-continue renderers now use plan v2 |
| Active translator task | P0-A18b2c: clear 13 simple scalar/out/record-pointer/opaque-context legacy renderers |
