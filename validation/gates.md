...
- `git diff --check` still runs after the evidence gates. Superpowers validation is limited to full-regression or historical-governance runs when explicitly enabled; it is not part of the default competition semantic gate.
