...
fn main() {
    let result_0 = fdb_calc_crc32(0u32, &[]);
    println!("{}\t{}", "empty-crc-zero", result_0);
    let result_1 = fdb_calc_crc32(0u32, &[49, 50, 51, 52, 53, 54, 55, 56, 57]);
    println!("{}\t{}", "ascii-123456789-crc-zero", result_1);
}
