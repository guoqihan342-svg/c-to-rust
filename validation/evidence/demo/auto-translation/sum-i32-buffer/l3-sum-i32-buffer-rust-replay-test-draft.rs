...
fn replay_sum_i32_buffer_fixture_contract() {
    ...
    let fixture_cases: &[FixtureCase] = &[
        FixtureCase { id: "empty", values: &[], len: 0i32, return_code: 0i32, status: "ok", sum: 0i32, source_reads: "values[i] under i < len", source_write: "out[0]" },
        FixtureCase { id: "single-positive", values: &[7i32], len: 1i32, return_code: 0i32, status: "ok", sum: 7i32, source_reads: "values[i] under i < len", source_write: "out[0]" },
        FixtureCase { id: "mixed-negative", values: &[-5i32, 2i32, -3i32, 6i32], len: 4i32, return_code: 0i32, status: "ok", sum: 0i32, source_reads: "values[i] under i < len", source_write: "out[0]" },
        FixtureCase { id: "boundary-safe", values: &[1073741823i32, 1073741823i32, -1i32], len: 3i32, return_code: 0i32, status: "ok", sum: 2147483645i32, source_reads: "values[i] under i < len", source_write: "out[0]" },
    ];
