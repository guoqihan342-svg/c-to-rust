...
- Current public packet contracts require `summary.workflow_metrics` and `quantitative_evaluation` to match the bound `judge-milestone-bundle.json`, with `semantic_gate=false` and `translation_coverage_numerator=0`.
