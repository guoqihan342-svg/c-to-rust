...
class ValidateCompetitionRunSummaryTests(unittest.TestCase):
    ...
    def test_rejects_translation_before_after_rollup_count_drift_from_per_unit_evidence(self) -> None:
        module = load_validator_module()
        summary = valid_summary()
        summary["slices"] = {
            "attempted": 1,
