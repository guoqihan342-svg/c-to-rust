...
def main() -> int:
    ...
    parser.add_argument("--slice-spec", action="append", dest="slice_specs", type=Path, required=True)
...
def run_competition(
    *,
    ...
    specs = [load_slice_spec(path, repo_root=repo_root) for path in slice_specs]
