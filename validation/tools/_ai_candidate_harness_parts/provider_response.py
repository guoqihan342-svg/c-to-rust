...
def render_prompt(context_pack: dict[str, Any]) -> str:
    ...
    return (
        ...
        "Implement the exact api_name shown by the generated replay API contract; function_name is "
        "the C source identity and may differ. The generated replay API contract is compiler-owned: "
