...
from .provider_readiness_callees import external_callee_source_context_status
from .provider_readiness_response_files import (
    response_file_contract_status as _response_file_contract_status,
)
...
def response_file_contract_status(context_pack: dict[str, Any]) -> str:
    return _response_file_contract_status(context_pack)
