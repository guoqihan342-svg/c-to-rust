...
def build_reporter_layout(workspace: Path) -> dict[str, object]:
    ...
    spec, fixture = build_field_scalar_add_spec(path_prefix=relative_prefix)
    fixture_path = workspace / "fixtures" / "field-scalar-add-cases.json"
    source_root = workspace / "upstream"
    source_path = source_root / "harbor.c"
    spec_path = workspace / "specs" / "field-scalar-add.json"
