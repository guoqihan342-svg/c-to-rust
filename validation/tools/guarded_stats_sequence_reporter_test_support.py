...
def build_reporter_layout(workspace: Path) -> dict[str, object]:
    ...
    fixture_path = workspace / "fixtures" / "guarded-stats-sequence-cases.json"
    source_root = workspace / "upstream"
    source_path = source_root / "guarded_stats.c"
    spec_path = workspace / "specs" / "guarded-stats-sequence.json"
