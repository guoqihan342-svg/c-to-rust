...
from validation.tools.replay_call_plan_v2 import _plan_sha256, validate_replay_call_plan_v2
...
FIELD_KEYS = {
    "initial_fixture_path", "expected_output", "expected_from_ref",
    "rust_field_path", "rust_type_path", "fixture_scalar_type",
    "rust_scalar_type", "conversion",
}
DEFAULT_KEYS = {"rust_field_path", "rust_type_path", "rust_scalar_type", "value"}


_PARTS_DIR = _Path(__file__).with_name("_replay_call_plan_record_buffer_identity_parts")
for _PART_NAME in (
    "part_00.pyfrag",
    "part_01.pyfrag",
    "part_02.pyfrag",
