...
_C2R_PARTS_DIR = _C2RPartPath(__file__).with_name("_test_opencode_agent_harness_parts")
...
class OpenCodeAgentHarnessTest(
    _OpenCodeAgentHarnessTestPart00,
    _OpenCodeAgentHarnessTestPart01,
    _OpenCodeAgentHarnessTestPart02,
    _OpenCodeAgentHarnessTestPart03,
    _OpenCodeAgentHarnessTestPart04,
    _OpenCodeAgentHarnessTestPart05,
    _OpenCodeAgentHarnessTestPart06,
    _OpenCodeAgentHarnessTestPart07,
    _OpenCodeAgentHarnessTestPart08,
    _OpenCodeAgentHarnessTestPart09,
    _OpenCodeAgentHarnessTestPart10,
    unittest.TestCase,
):
    pass
