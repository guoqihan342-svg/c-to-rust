# English Mirror: L3 Template README

Chinese original: `README.md`.

This file is the English mirror for `validation/l3-template/README.md`. The Chinese source is the authoritative maintenance document; update this file in the same change whenever the Chinese document changes.
