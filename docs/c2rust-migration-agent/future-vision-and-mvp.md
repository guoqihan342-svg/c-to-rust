...
- [ ] **P0-A19：陌生 C 项目整项目 AI harness 泛化**
  ...
  **下一执行顺序（按完成条件推进，不按测试用例身份推进）**：
  ...
  2. A19d3d2a2g2-g3 已关闭；现在关闭 g4 的独立重开。Cargo metadata、实际编译、linker/ELF/archive witness 与 RustProjectIR v3 完全一致后，结构重建才算闭合。
