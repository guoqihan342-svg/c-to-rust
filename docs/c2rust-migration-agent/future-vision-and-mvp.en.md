...
| Active translator track | P0-A18c / P0-A10 | A18c8a/A18c8b/A18c8b1/A18c8c1/A18c8c2 are closed; next extend A18c8c with output-parameter and record-field projections, while separately closing function-table indirect calls and record-layout `sizeof` gaps |
| External parallel track | P0-H9 | Revalidate the exact OpenCode + GLM-5.1 contract on the real competition host |
| Latest development stage | P0-A18c8c2 | Generic C call plans now use strict JSON output records bound to plan SHA, case, field, encoding, and actual value; fresh and strict validators recompute the gate from persisted stdout, while record output parameters remain fail closed |
...
| 2 | P0-A18c8 remaining exact-failure closure | In progress | A18c8a/A18c8b/A18c8b1/A18c8c1/A18c8c2 are complete; next extend the generic C-oracle call plan with output parameters and record-field projections while AI, deterministic fallback, and exact validation continue handling the remaining semantic gaps |
