...
| 2 | P0-A12 file-based prompt transport | Candidate and repair paths no longer place a large ContextPack in process argv |
...
- [ ] **P0-A12: file-based prompt transport**
