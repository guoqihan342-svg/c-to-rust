...
| Active translator track | P0-A18c / P0-A10 | A18c8a/A18c8b/A18c8b1 are closed; next implement the A18c8c generic executable C-oracle call plan and separately close function-table indirect calls and record-layout `sizeof` gaps |
| External parallel track | P0-H9 | Revalidate the exact OpenCode + GLM-5.1 contract on the real competition host |
| Latest development stage | P0-A18c8b1 | The translator now replays a hash-bound compile DB, real translation unit, and macro-expanded function selection; real projects fail closed at unproven indirect-call or record-layout boundaries |
...
| 2 | P0-A18c8 remaining exact-failure closure | In progress | A18c8a/A18c8b/A18c8b1 are complete; next make a generic C-oracle call plan execute fixture calls and output comparison while AI, deterministic fallback, and exact validation continue handling the remaining semantic gaps |
