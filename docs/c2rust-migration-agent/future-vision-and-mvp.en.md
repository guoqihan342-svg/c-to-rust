...
| Latest development stage | P0-A16 | Model identity, auxiliary scope, tool-free agent, dynamic candidate id, and OpenCode 1.17.18 transport are closed |
...
| 7 | P0-A10 fixed-suite real acceptance | Run the complete suite once after GLM resource recovery and publish reproducible metrics |
| 8 | P0-A6 / P0-H9 competition-host replay | A valid resource package and competition-exact host are available; simulation cannot substitute |
