# English Mirror: Architecture

Chinese original: `architecture.md`.

This file is the English mirror for `docs/c2rust-migration-agent/index/architecture.md`. The Chinese source is the authoritative maintenance document; update this file in the same change whenever the Chinese document changes.
...
- Keep filenames paired as `architecture.md` and `architecture.en.md` in the same directory.
- Keep the first line of the Chinese source pointing to `architecture.en.md` with the repository-standard mirror notice.
