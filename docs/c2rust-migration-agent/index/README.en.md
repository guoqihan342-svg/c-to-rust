# English Mirror: Index README

Chinese original: `README.md`.

This file is the English mirror for `docs/c2rust-migration-agent/index/README.md`. The Chinese source is the authoritative maintenance document; update this file in the same change whenever the Chinese document changes.
