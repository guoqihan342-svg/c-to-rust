...
| 最近开发阶段 | P0-A18b2c1：4 个 scalar-return renderer 已归一化为 declarative plan |
| 当前翻译任务 | P0-A18b2c：清理剩余 9 个 mutable-out/record-pointer/opaque-context legacy renderer |
