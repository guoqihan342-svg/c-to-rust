...
| 最近开发阶段 | P0-A18b2b2b：4 个 scripted external/call-continue renderer 已全部迁入 plan v2 |
| 当前翻译任务 | P0-A18b2c：清理 13 个 scalar/out/record-pointer/opaque-context 简单 legacy renderer |
