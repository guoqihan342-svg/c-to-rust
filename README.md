...
| 最近开发阶段 | P0-A18b2b2a：9 个 record-state renderer 已全部迁入 plan v2，readonly record 参数使用共享借用 |
| 当前翻译任务 | P0-A18b2b2b：迁移 4 个 scripted external/call-continue；随后清理 A18b2c 的 13 个简单 legacy renderer |
