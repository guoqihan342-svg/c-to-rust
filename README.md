...
| 最近开发阶段 | P0-A18b2c2：3 个 mutable-output renderer 已归一化为 plan v2 |
| 当前翻译任务 | P0-A18b2c：清理剩余 6 个 mutable-out/record-pointer/opaque-context legacy renderer |
